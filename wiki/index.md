...
- [Nabeel S. Qureshi](guests/nabeel-s-qureshi.md) — Founder/writer, ex-Palantir VP Biz Dev; Forward Deployed Engineers, Palantir culture, founder training
- [Nan Yu](guests/nan-yu.md) — Head of Product at Linear; beloved B2B products, Linear Method, speed + quality
- [Nancy Duarte](guests/nancy-duarte.md) — CEO Duarte Inc.; storytelling and presentations, What Is/What Could Be structure
- [Naomi Gleit](guests/naomi-gleit.md) — Head of Product Meta; disagreeable givers, extreme clarity, working with Zuckerberg
- [Naomi Ionita](guests/naomi-ionita.md) — Partner Menlo Ventures, ex-Evernote/Invoice2go; pricing strategy, freemium, modern growth stack
- [Nick Turley](guests/nick-turley.md) — Head of ChatGPT at OpenAI; fastest growing product ever, AI product development, evals
...
- [DORA Metrics](frameworks/dora-metrics.md) — Four metrics for software delivery performance: deployment frequency, lead time, MTTR, change failure rate
- [Forward Deployed Engineer (FDE) Model](frameworks/forward-deployed-engineer.md) — Palantir's model: embed engineers at customer sites to deliver outcomes, not just software
...
- [Developer Experience (DevEx)](concepts/developer-experience.md) — Holistic measure of how frictionless developer work feels; SPACE + DORA dimensions
- [Disagreeable Givers](concepts/disagreeable-givers.md) — Naomi Gleit's model: people who give freely but push back on ideas; most effective collaborators
