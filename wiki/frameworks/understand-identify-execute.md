...
- [[naomi-gleit]] — Facebook's growth team independently arrived at the same framework. In January 2009, Naomi's team paused their entire roadmap for one month to do nothing but instrument data — tagging every step of the registration flow and onboarding experience. Alex Schultz's motto: "I guess when you can know." Only after that month did the team shift to Identify and Execute. Naomi calls this the foundation of the growth team's success: proving that product (not marketing) drives growth, and grounding every decision in instrumented data. (Meta's head of product on working with Mark Zuckerberg, early growth tactics, and more)
